...
def train(input_tensor, target_tensor, emo_id, encoder, decoder, emotion_predict, encoder_optimizer, decoder_optimizer, emotion_optimizer, criterion, max_length=MAX_LENGTH):
